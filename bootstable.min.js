            ...
            function rowAgreg(){
                if(0==$tab_en_edic.find("tbody tr").length){
                    ...
                    (i=$tab_en_edic.find("thead tr").find("th")).each(function(){
                        "buttons"==$(this).attr("name")?t+=colEdicHtml:t+="<td></td>"}),$tab_en_edic.find("tbody").append("<tr>"+t+"</tr>")
                    }else{
